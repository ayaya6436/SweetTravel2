 ...
 * @author user
 */
public class recheClient extends javax.swing.JInternalFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(36, 36, 36)
                        .addComponent(txtclient, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(61, 61, 61)
...
//              txtid.setText("CL" + String.format("%03d", id));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection("jdbc:mysql://localhost/sweettravel","root","");
            pst = con.prepareStatement("UPDATE client SET prenom=?,nom=?,nic=?,passeport=?,adresse=?,ddn=?,genre=?,contact=?,photo=? WHERE id=?");
            ...
            JOptionPane.showMessageDialog(null," Mise a jour effectue");
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
             ...
             if(rs.next()== false){
                 ...
                 String ddn = rs.getString("ddn");
                 Date date1 = new SimpleDateFormat("yyy-MM-dd").parse(ddn);
                 ...
                 if (genre.equals("Masculin")){
                    ...
                    txtadresse.setText(adresse.trim());
                    txtcontact.setText(contact.trim());
                    txtddn.setDate(date1);
            ...
            Logger.getLogger(recheClient.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(recheClient.class.getName()).log(Level.SEVERE, null, ex);
